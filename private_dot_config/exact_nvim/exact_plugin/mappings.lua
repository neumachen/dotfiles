if not config or not config.mappings.enable then return end

local fn, api, uv, cmd, command, fmt = vim.fn, vim.api, vim.uv, vim.cmd, config.command, string.format
...
if config.falsy(fn.mapcheck('<ScrollWheelDown>')) then nmap('<ScrollWheelDown>', '<c-d>') end
if config.falsy(fn.mapcheck('<ScrollWheelUp>')) then nmap('<ScrollWheelUp>', '<c-u>') end
------------------------------------------------------------------------------
-- Buffers
------------------------------------------------------------------------------
...
---@param type string
---@return nil
function config.mappings.grep_operator(type)
...
-----------------------------------------------------------------------------//
nnoremap('<leader>ls', config.list.qf.toggle, { desc = 'toggle quickfix list' })
nnoremap('<leader>ll', config.list.loc.toggle, { desc = 'toggle location list' })
-----------------------------------------------------------------------------//
-- Completion
-----------------------------------------------------------------------------//
