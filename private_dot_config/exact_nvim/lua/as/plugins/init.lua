...
return {
  ...
  },
  {
    'mbbill/undotree',
    cmd = 'UndotreeToggle',
    keys = { { '<F5>', '<Cmd>UndotreeToggle<CR>', desc = 'undotree: toggle' } },
    config = function()
  ...
  },
  {
    ...
    keys = {
      ...
      { '<C-d>', function() require('readline').kill_word() end, mode = '!' },
      { '<C-BS>', function() require('readline').backward_kill_word() end, mode = '!' },
