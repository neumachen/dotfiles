...
return {
  {
    ...
    keys = {
      ...
      { '<leader>fld', fzf_lua.diagnostics_workspace, desc = 'workspace diagnostics' },
      ...
      { '<leader>fcd', function() file_picker(vim.env.DOTFILES) end, desc = 'dotfiles' },
      { '<leader>fcn', function() file_picker(vim.g.vim_dir) end, desc = 'nvim config' },
